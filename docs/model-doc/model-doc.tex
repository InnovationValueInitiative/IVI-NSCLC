...
\begin{center}
\begin{threeparttable}
\caption{Patient characteristics in 1L studies, demographics and smoking status} \label{tbl:patchar-1-1L}
\tiny
...
\begin{center}
\begin{threeparttable}
\caption{Patient characteristics in 2L studies, demographics and smoking status} \label{tbl:patchar-1-2L}
\tiny
\begin{tabularx}{\textwidth}{@{\extracolsep{\fill}}llp{0.20\linewidth}rrrrrrrrrr}
\hline
\multicolumn{3}{c}{} & \multicolumn{3}{c}{Age} & \multicolumn{1}{c}{} & \multicolumn{2}{c}{Race/ethnicity (\%)} & \multicolumn{4}{c}{Smoking status (\%)}\\
...
\begin{center}
\begin{threeparttable}
\caption{Patient characteristics in 1L studies, disease stage and functional status} \label{tbl:patchar-2-1L}
\tiny
...
\begin{center}
\begin{threeparttable}
\caption{Patient characteristics in 2L studies, disease stage and functional status} \label{tbl:patchar-2-2L}
\tiny
\begin{tabularx}{\textwidth}{@{\extracolsep{\fill}}llp{0.20\linewidth}lrrrrrrrrrrr}
\hline
\multicolumn{3}{c}{} & \multicolumn{1}{c}{Performance} & \multicolumn{4}{c}{Performance status} & \multicolumn{7}{c}{Disease stage}\\
