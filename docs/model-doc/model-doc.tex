...
The clinical trials used to estimate treatment effects are provided in \autoref{tbl:trials}.
...
\autoref{tbl:studychar-1-1L}-\autoref{tbl:studychar-3-2L} provide information on the study design characteristics for the studies used to estimate PFS and OS.
...
\autoref{tbl:patchar-1-1L}-\autoref{tbl:patchar-3-2L} provides information on the study populations of the different studies used to estimate PFS and OS. \autoref{fig:female-1l}-\autoref{fig:currentformermoker-1l} shows the distribution of key characteristics across the studies. 
